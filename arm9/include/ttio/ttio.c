...
bool TTIO_Startup(void) { return SCDSSDHC_SDInitialize(); }

// Returns true if a card is present and initialized.
bool TTIO_IsInserted(void) { return true; }
...
bool TTIO_ClearStatus(void) { return true; }

// Shutdowns the card. This may never be called.
bool TTIO_Shutdown(void) { return true; }
